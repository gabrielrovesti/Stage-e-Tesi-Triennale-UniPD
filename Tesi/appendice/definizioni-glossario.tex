...
\newglossaryentry{ideg}{
    ...
    Solitamente un \emph{IDE} è composto da un editor di codice sorgente, un compilatore ed un \textit{debugger}. 
...
\newglossaryentry{w3cg}{
    ...
    text=W3C,
    sort=w3c,
    description={Il \emph{World Wide Web Consortium} (\textit{W3C}) è un'organizzazione internazionale che ha come scopo quello di sviluppare tutte le potenzialità del \textit{World Wide Web}. 
    Il \textit{W3C} produce e promuove standard tecnici aperti e liberi per il Web, allo scopo di garantirne la crescita e l'innovazione attraverso l'implementazione di nuove tecnologie e standard.
...
\newglossaryentry{ssig}{
    ...
    In un sistema di identità digitale \textit{SSI}, l'utente ha il pieno controllo dei propri dati personali 
    ...
    per la gestione delle identità digitali, aumentando la sicurezza e la \textit{privacy} degli utenti. 
    L'\textit{SSI} si basa su tecnologie come la \textit{blockchain} e la crittografia, che consentono di creare registri distribuiti e sicuri delle 
...
\newglossaryentry{didg}{
    ...
    Questo è basato su tecnologie decentralizzate e distribuite come \textit{blockchain}, sviluppato come parte dello standard \textit{W3C} Verifiable Credentials,
...
\newglossaryentry{vcg}{
    ...
    contenendo le informazioni principali di una persona come nome, cognome, data di nascita, luogo di nascita, ecc. Anche questo è basato su tecnologie decentralizzate e distribuite come \textit{blockchain},
...
\newglossaryentry{zkpg}{
    ...
    senza doverlo rivelare. Le \textit{ZKP} sono utilizzate in diverse applicazioni, come la verifica dell'identità digitale, la gestione delle transazioni finanziarie, la condivisione delle informazioni sensibili}
}
...
\newglossaryentry{ethereumg}{
    ...
    La piattaforma è basata su una \textit{blockchain} pubblica e permette di creare applicazioni decentralizzate che possono essere eseguite in una macchina virtuale
...
\newglossaryentry{ethersjsg}{
    ...
    text=Ethers.js,
    sort=ethers.js,
    description={In informatica con il termine \emph{Ethers.js} si indica una libreria \textit{JavaScript} per interagire con la \textit{blockchain} di \textit{Ethereum}. 
...
\newglossaryentry{solidityg}{
    ...
    text=Solidity,
    sort=solidity,
    description={In informatica con il termine \emph{Solidity} si indica un linguaggio di programmazione ad alto livello per la creazione di \textit{smart contract}. 
    Esso ha una sintassi simile ai linguaggi \textit{C++, Java} e \textit{JavaScript}, progettato per fornire un livello di sicurezza e affidabilità elevato per la gestione
    ed esecuzione dei contratti intelligenti sulla \textit{blockchain} di \textit{Ethereum}. 
...
\newglossaryentry{web3jsg}{
    ...
    text=Web3.js,
    sort=web3.js,
    description={In informatica con il termine \emph{Web3.js} si indica una libreria \textit{JavaScript} per interagire principalmente con la \textit{blockchain} di \textit{Ethereum}. 
    La libreria permette di creare applicazioni decentralizzate che possono essere eseguite in un \textit{browser} web.
    ...
    e la lettura dei dati dalla blockchain.\ La libreria è basata su tecnologie di crittografia asimmetrica e sulla comunicazione con i nodi della \textit{blockchain} di \textit{Ethereum} attraverso il protocollo \textit{JSON-RPC}}
}
...
\newglossaryentry{vpg}{
    ...
    non contenenti informazioni personali, ma solo un identificatore univoco. Anche questo è basato su tecnologie decentralizzate e distribuite come \textit{Ethereum}}
}
...
\newglossaryentry{dappg}{
    ...
    description={In informatica con il termine \emph{Decentralized Application (DApp)} (ing.\ applicazione decentralizzata) si indica un'applicazione che utilizza una \textit{blockchain} per la gestione dei dati e delle transazioni.
...
\newglossaryentry{smartcontractg}{
    ...
    Questi sono eseguiti in una \textit{blockchain}, in particolare in quella di \textit{Ethereum}, e sono scritti in un linguaggio di programmazione ad alto livello chiamato \textit{Solidity}}
}
...
\newglossaryentry{jsong}{
    ...
    Questo formato è basato su coppie chiave-valore, in cui la chiave è una stringa e il valore può essere un oggetto, un vettore, un numero, una stringa, un booleano o nullo.
    Tale formato si adatta bene alla memorizzazione di dati strutturati, come ad esempio le informazioni contenute in una ase di dati}
}
...
\newglossaryentry{opensourceg}{
    ...
    text=open source,
    sort=open source,
    description={In informatica con il termine \emph{open source} si indica un software di cui viene reso pubblico il codice sorgente, permettendo a chiunque di poterlo utilizzare, 
    studiare, modificare e distribuire liberamente}
}