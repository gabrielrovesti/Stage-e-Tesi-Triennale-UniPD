...
\newglossaryentry{agileg}{
    ...
    Questa si base su un'interazione costate e flessibile, basato più sugli individui e le interazioni che sugli strumenti e i processi}
}
...
\newglossaryentry{umlg} {
    ...
    e progettare sistemi complessi. Questo fornisce un insieme di notazioni grafiche atte a definire il sistema e i suoi comportament, comprendendo ogni parte di interazione e comunicazione
    tra le varie parti. Esso viene utilizzato nelle fasi di analisi dei requisiti, progettazione, impelmentazione e test del prodotto software.
...
\newglossaryentry{solidityg}{
    ...
    Esso ha una sintassi simile ai linguaggi C++, Java e JavaScript, progettato per fornire un livello di sicureza e affidabilità elevato per la gestione
...
\newglossaryentry{vpg}{
    ...
    ciascuna contenente una serie di credenziali con un verificatore specifico, in grado di evidenziare la paternità dei dati diopo un processo di verifica,
