...
\newglossaryentry{web3jsg}{
    ...
    e la lettura dei dati dalla blockchain.\ ethers.js è basata su tecnologie di crittografia asimmetrica e sulla comunicazione con i nodi della \textit{blockchain} di \textit{Ethereum} attraverso il protocollo \textit{JSON-RPC}}
}
