...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth, alt={Blocco all'interno di una blockchain}]{immagini/blocco.jpeg}
...
\begin{enumerate}
    ...
    I miner utilizzano la loro potenza di calcolo per cercare di risolvere per primi questi problemi matematici
    e il primo miner a riuscirci viene ricompensato in criptovaluta per il lavoro svolto.
...
\begin{itemize}
    ...
    \item \textit{VC (Verifiable Credentials)}, che consente di gestire attestazioni verificati, quindi insiemi di informaizoni cfhe un individuo
