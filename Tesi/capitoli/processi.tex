...
Esso si basa sul protocollo è \textit{Hyperledger Indy}, che è un \glsfirstoccur{\gls{frameworkg}} \textit{open source }per la creazione di SSI basato su \textit{blockchain}
