...
\begin{itemize}
    ...
    \item{\textit{\textbf{StarUML}}}, per la realizzazione dei diagrammi \gls{uml} del documento, quindi per i diagrammi dei casi d'uso e dei diagrammi delle classi;
...
\subsection{Scrittura del documento}
