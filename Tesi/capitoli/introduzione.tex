...
\intro{In questo capitolo verrà descritta l'azienda sede del tirocinio, l'organizzazione del testo e delle convenzioni tipografiche impostate.}
...
\section{Way of Working e strumenti}\label{sec:way-of-working}
...
\subsection{Convenzioni tipografiche}\label{sec:convenzioni-tipografiche}
