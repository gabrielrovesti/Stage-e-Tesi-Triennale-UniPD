...
function createFixtureLoader(overrideProvider, overrideWallets) {
    const snapshots = [];
    return async function load(fixture) {
        ...
        if (snapshot) {
            ...
            const provider = overrideProvider || provider_1.createMockProvider();
            const wallets = overrideWallets || provider_1.getWallets(provider);
